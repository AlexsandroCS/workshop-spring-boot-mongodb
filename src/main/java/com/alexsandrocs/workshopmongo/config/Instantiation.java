package com.alexsandrocs.workshopmongo.config;

import com.alexsandrocs.workshopmongo.domain.Post;
import com.alexsandrocs.workshopmongo.domain.User;
import com.alexsandrocs.workshopmongo.dto.AuthorDTO;
import com.alexsandrocs.workshopmongo.dto.CommentDTO;
import com.alexsandrocs.workshopmongo.repository.PostRepository;
import com.alexsandrocs.workshopmongo.repository.UserRepository;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        CommentDTO c3 = new CommentDTO("Tenha um ótimo dia!",sdf.parse("23/03/2023"), new AuthorDTO(bob));
